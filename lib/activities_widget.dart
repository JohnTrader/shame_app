import 'dart:ui';
import 'package:shame_app/activity_box_widget.dart';
import 'package:shame_app/sensor_data.dart';
import 'package:shame_app/graph.dart';
import 'package:shame_app/hobbies_icons.dart';
...
class _ActivitiesWidgetState extends State<ActivitiesWidget> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    var values = allStats[selectedHobby]?.statsMap[selectedDuration];
  }
